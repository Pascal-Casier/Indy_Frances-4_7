...
@onready var label_3d_1: Label3D = $arche_triple/Cube_001/Label3D
@onready var label_3d_2: Label3D = $arche_triple/Cube_002/Label3D2
@onready var label_3d_3: Label3D = $arche_triple/Cube_003/Label3D3
@onready var area_3d_1: Area3D = $Area3D
