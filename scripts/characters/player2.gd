...
@export var jump_heigth: float = 2.0
...
func calculate_movement_parameters()->void:
	gravity = (2*jump_heigth)/pow(jump_peak_time,2)
	fall_gravity = (2*jump_heigth)/pow(jump_fall_time,2)
	vertical_velocity = gravity * jump_peak_time
